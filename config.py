...
parser.add_argument('--fp16', type=bool, default=False, help='T4 전용(T4는 지원안함 A100은 지원)')
parser.add_argument('--bf16', type=bool, default=False, help='T4 전용(T4는 지원안함 A100은 지원)')
# T4에서 fp16,bg16 구동시 발생오류 [Error:Your setup doesn't support bf16/gpu. You need torch>=1.10, using Ampere GPU with cuda>=11.0]
# parser.add_argument('--fp16', type=bool, default=True, help='A100전용(T4는 지원안함 A100은 지원)')
# parser.add_argument('--bf16', type=bool, default=True, help='A100전용(T4는 지원안함 A100은 지원)')
